...
class ListBookAdapter(private val listBook: ArrayList<Book>) :
    ...
    override fun onBindViewHolder(
        ...
        val (name, description, image) = listBook[position]
    ...
    class ListViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val imgPhoto: ImageView = itemView.findViewById(R.id.img_book_photo)
        val tvName: TextView = itemView.findViewById(R.id.tv_book_name)
